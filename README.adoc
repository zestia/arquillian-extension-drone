...
[NOTE]
This is a fork of https://github.com/arquillian/arquillian-extension-drone[Arquillian Drone] with fixes for M1 Macs &
later ChromeDriver versions which haven't been released yet. Releases are published to GH packages for internal Zestia
usage.
